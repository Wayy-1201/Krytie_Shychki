...
class User(db.Model):
    ...
    # MutableDict гарантирует, что любые изменения внутри state сохранится в БД
    state = db.Column(MutableDict.as_mutable(db.JSON), default=lambda: DEFAULT_STATE.copy())
